...
mongoose.connect("mongodb+srv://anil:anilkumar1234@cluster5.658rp.mongodb.net/mycollections")
...
app.get("/",(req,res)=>{
    res.send("Express App is Running on port")
})
...
// creating end point for popular in section
